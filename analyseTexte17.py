...
def parse_line(line, id, sexe=None, parent_id_pere=None, parent_id_mere=None, couple_id_homme=None, couple_id_femme=None):
    ...
    for paragraph in paragraphs:
        ...
        if not os.path.exists(csv_file_path):
            with open(csv_file_path, mode='w', newline='', encoding='latin-1') as file:
                ...
                writer.writerow(["prenom", "sexe"])  # Ajouter l'en-tête si le fichier n'existe pas
